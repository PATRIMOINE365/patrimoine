...
class AuthController extends Controller
{
    ...
    /**
     * Update the currently authenticated user's own profile identity.
     *
     * Self-service profile editing is deliberately limited to non-security
     * identity fields. Role and active status remain Administrator-managed.
     */
    public function updateMe(
        ...
        /*
         * A profile save that changes nothing is not a meaningful human
         * action and therefore does not create Activity Log noise.
         */
        if ($changedBefore !== []) {
            $activityLog->record(
                action: 'user.updated',
