...
@section('title', __('emails.email_change_proposed.title'))

@section('preheader')
    {{ __('emails.email_change_proposed.preheader') }}
@endsection

@section('content')
    <h1 style="margin:0 0 18px 0; font-size:20px; line-height:30px; color:#123D35; font-weight:600;">
        {{ __('emails.email_change_proposed.heading') }}
    </h1>

    <p style="margin:0 0 14px 0;">
        {{ __('emails.email_change_proposed.greeting', ['name' => $user->name]) }}
    </p>

    <p style="margin:0 0 24px 0;">
        {{ __('emails.email_change_proposed.introduction', [
