...
export const translations = {
    en: {
        ...
        'password.current_password':
            'Current password',
        'password.profile_updated': 'Your profile has been updated.',
'password.profile_both_required': 'Enter both your new password and your current password.',
'password.change_action':
    ...
    fr: {
        ...
        'password.current_password':
            'Mot de passe actuel',
        'password.profile_updated': 'Votre profil a été mis à jour.',
'password.profile_both_required': 'Saisissez votre nouveau mot de passe ainsi que votre mot de passe actuel.',
'password.change_action':
